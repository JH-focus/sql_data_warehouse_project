...
PRINT '>> Loading Table data: bronze.crm_cust_info';
...
PRINT '>> Loading Table data: bronze.crm_prod_info';
...
PRINT '>> Loading Table data: bronze.crm_sales_details';
...
PRINT '>> Loading Table data: bronze.erp_cust_az12';
...
PRINT '>> Loading Table data: bronze.erp_loc_a101';
...
PRINT '>> Loading Table data: bronze.erp_px_cat_g1v2';
