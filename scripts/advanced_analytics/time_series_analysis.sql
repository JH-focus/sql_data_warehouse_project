...
--for correct aggregation, it is important, not to use the same column name
--as the original column
--correct formatting in postgreSQL is achieved by the TO_CHAR function
...
--in order to correctly display the ordered dates, the DATE_TRUNC() Function ist necessary
